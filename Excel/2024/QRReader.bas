...
Sub saveData(inp As String)
    ...
    mapper.add "al", "autoLeave"
    mapper.add "asc", "Auto Speaker Scores"
    mapper.add "asm", "Auto Speaker Misses"
    mapper.add "aas", "Auto Amp Scores"
    mapper.add "aam", "Auto Amp Misses"
    
    ' Teleop
    mapper.add "tsc", "Near Score"
    mapper.add "tsm", "Near Miss"
    mapper.add "tsfc", "Far Score"
    mapper.add "tsfm", "Far Miss"
    mapper.add "tas", "Amp Scores"
    mapper.add "tam", "Amp Misses"
    mapper.add "pt", "Pickup Type"
    
    'Endgame
    mapper.add "fs", "Final Status"
    mapper.add "cp", "Chain Position"
    mapper.add "nit", "Trap"
    mapper.add "hp", "High Note Attempt"
    mapper.add "madehp", "High Note Scored"
    'Postmatch
    mapper.add "ds", "driverSkill"
    mapper.add "dr", "defenseRating"
    mapper.add "sr", "speedRating"
    mapper.add "die", "Died or Immobilized"
    mapper.add "tip", "Tippy"
    mapper.add "dn", "Note Stuck"
    mapper.add "co", "comments"
    mapper.add "pe", "Penalties"
